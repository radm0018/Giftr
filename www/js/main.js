...
let giftListPerson; //this deterines who we are looking at when at the gifts page
let currentPerson;

//localStorage.removeItem("giftr-radm0018");
...
function savePerson() {
    ...
    //display the list of people on the main screen
    displayPeopleList();
}

function displayPeopleList() {
    getFromLocalStorage();
    console.log("testing display people function at top");
...
function saveToLocalStorage() {
    localStorage.setItem("giftr-radm0018", JSON.stringify(people));
}

function getFromLocalStorage() {
    if (!localStorage.getItem("giftr-radm0018")) {
        console.log("No data found");
    }
    else {
        people = JSON.parse(localStorage.getItem("giftr-radm0018"));
